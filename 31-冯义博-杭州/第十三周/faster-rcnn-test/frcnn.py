from tensorflow.keras.layers import Input, Dense, Conv2D, Reshape, TimeDistributed, Flatten
...
class FRCNN(object):
    ...
    def generate(self):
        ...
        # 否则先构建模型再载入
        self.model_rpn, self.model_classifier = get_predict_model(self.config, self.num_classes)
